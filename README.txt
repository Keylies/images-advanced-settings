...
Tags: images, image, attachments, attachment, settings, sizes, regenerate, regeneration
Requires at least: 3.0.1
Tested up to: 4.9.8
License: GPLv3 or later
License URI: https://www.gnu.org/licenses/gpl-3.0.html

Additionnal settings for WordPress images
...
2. Upload it to your webserver in your plugins directory. Follow [WordPress Codex instructions](https://codex.wordpress.org/Managing_Plugins#Manual_Plugin_Installation).
